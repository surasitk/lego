...
insert into public.minifigures (name_th, name_en, series, set_no, release_date, release_sort, category, bricklink_id, image_url, confidence, emoji, identified, note) values
  ...
  ('สาวชุดสตรอว์เบอร์รีเค้ก', 'Strawberry Shortcake Girl', 'Build-A-Minifigure', 'BAM 2023', '2023', 20230601, 'food', 'hol355x', 'https://i.ebayimg.com/images/g/xiIAAOSwQKtoGRgo/s-l1600.jpg', 'sure', '🍓', true, NULL),
