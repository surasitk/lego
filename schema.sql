...
insert into public.minifigures (name_th, name_en, series, set_no, release_date, release_sort, category, bricklink_id, image_url, confidence, emoji, identified, note) values
  ...
  ('สาวชุดสตรอว์เบอร์รีเค้ก', 'Strawberry Shortcake Girl', 'Build-A-Minifigure', 'BAM 2023', '2023', 20230601, 'food', 'hol355x', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/strawberry.jpg', 'sure', '🍓', true, NULL),
  ...
  ('ราชินีอียิปต์', 'Egyptian Queen', 'Series 5', '8805', '2011', 20110902, 'myth', 'col078', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/col078.png', 'sure', '🐍', true, NULL),
  ('ราชินี', 'Queen', 'Series 15', '71011', 'Jan 2016', 20160103, 'castle', 'col243', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/col243.png', 'sure', '👸', true, NULL),
  ('กัปตันโจรสลัด (Redbeard)', 'Pirate Captain (Redbeard)', 'Pirates', NULL, '1989', 19890101, 'pirate', 'pi055', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/pi055.png', 'sure', '🏴‍☠️', true, NULL),
  ('ทหารอิมพีเรียล (Bluecoat)', 'Imperial Soldier', 'Pirates', NULL, '1996', 19960101, 'pirate', 'pi061', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/pi061.png', 'sure', '🪖', true, NULL),
