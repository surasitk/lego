...
insert into public.minifigures (name_th, name_en, series, set_no, release_date, release_sort, category, bricklink_id, image_url, confidence, emoji, identified, note) values
  ...
  ('ราชาสมุทร / โพไซดอน', 'Ocean King (Poseidon)', 'Series 7', '8831', 'May 2012', 20120501, 'fantasy', 'col101', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/col101.png', 'sure', '🔱', true, NULL),
  ...
  ('ราชาคลาสสิก', 'Classic King', 'Series 13', '71008', 'Jan 2015', 20150102, 'fantasy', 'col195', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/col195.png', 'sure', '👑', true, NULL),
  ...
  ('ชุดมังกรแดง', 'Dragon Suit Guy', 'Series 18', '71021', 'Apr 2018', 20180401, 'fantasy', 'col318', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/col318.png', 'sure', '🐉', true, NULL),
  ('ชุดพลุ (BANG)', 'Firework Guy', 'Series 18', '71021', 'Apr 2018', 20180402, 'fantasy', 'col316', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/col316.png', 'sure', '🎆', true, NULL),
  ...
  ('ชุดสีเทียน', 'Crayon Girl', 'The LEGO Movie 2', '71023', 'Feb 2019', 20190202, 'craft', 'tlm152', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/tlm152.png', 'sure', '🖍️', true, NULL),
  ...
  ('ชุดมังกรเขียว', 'Green Dragon Costume', 'Series 23', '71034', 'Sep 2022', 20220902, 'fantasy', 'col409', 'https://qmmopgyevfuztpqaynww.supabase.co/storage/v1/object/public/minifigs/col409.png', 'sure', '🐲', true, NULL),
