...
insert into public.minifigures (name_th, name_en, series, set_no, release_date, release_sort, category, bricklink_id, image_url, confidence, emoji, identified, note) values
  ...
  ('แกลดิเอเตอร์', 'Gladiator', 'Series 5', '8805', '2011', 20110901, 'fantasy', 'col066', 'https://img.bricklink.com/ItemImage/MN/0/col066.png', 'fair', '⚔️', true, NULL),
  ...
  ('สาวชุดสตรอว์เบอร์รีเค้ก', 'Strawberry Shortcake Girl', 'LEGO Exclusive', NULL, '2023', 20230601, 'food', 'hol355x', 'https://img.bricklink.com/ItemImage/MN/0/hol355x.png', 'sure', '🍓', true, NULL),
  ...
  ('นักรบนก/อินทรี (แขนขนนก)', NULL, NULL, NULL, NULL, 99990000, NULL, NULL, NULL, 'guess', '🦅', false, 'อาจเป็นไลน์ Chima หรือชุดนก — ส่งรูปใกล้ๆ มาช่วยฟันธงได้');
