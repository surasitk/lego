...
FIGS = [
    ...
    dict(th="สาวชุดสตรอว์เบอร์รีเค้ก", en="Strawberry Shortcake Girl", series="Build-A-Minifigure", set_no="BAM 2023", date="2023", sort=20230601, cat="food", bl="hol355x", img="https://i.ebayimg.com/images/g/xiIAAOSwQKtoGRgo/s-l1600.jpg", conf="sure", emoji="🍓"),
