...
FIGS = [
    ...
    dict(th="ชุดฮอตดอก", en="Hot Dog Man", series="Series 13", set_no="71008", date="ม.ค. 2015", sort=20150101, cat="food", bl="col208", conf="sure", emoji="🌭"),
    dict(th="ราชาคลาสสิก", en="Classic King", series="Series 13", set_no="71008", date="ม.ค. 2015", sort=20150102, cat="fantasy", bl="col195", conf="sure", emoji="👑"),
    dict(th="ชุดฉลาม", en="Shark Suit Guy", series="Series 15", set_no="71011", date="ม.ค. 2016", sort=20160101, cat="animal", bl="col240", conf="sure", emoji="🦈"),
    dict(th="ชุดกล้วย", en="Banana Guy", series="Series 16", set_no="71013", date="ก.ย. 2016", sort=20160901, cat="food", bl="col258", conf="sure", emoji="🍌"),
    dict(th="เด็กชุดเพนกวิน", en="Penguin Boy", series="Series 16", set_no="71013", date="ก.ย. 2016", sort=20160902, cat="animal", bl="col253", conf="fair", emoji="🐧"),
    ...
    dict(th="ชุดข้าวโพด", en="Corn Cob Guy", series="Series 17", set_no="71018", date="พ.ค. 2017", sort=20170501, cat="food", bl="col289", conf="sure", emoji="🌽"),
    dict(th="ชุดมังกรแดง", en="Dragon Suit Guy", series="Series 18", set_no="71021", date="เม.ย. 2018", sort=20180401, cat="fantasy", bl="col318", conf="sure", emoji="🐉"),
    dict(th="ชุดพลุ (BANG)", en="Firework Guy", series="Series 18", set_no="71021", date="เม.ย. 2018", sort=20180402, cat="fantasy", bl="col316", conf="sure", emoji="🎆"),
    dict(th="ชุดกระบองเพชร", en="Cactus Girl", series="Series 18", set_no="71021", date="เม.ย. 2018", sort=20180403, cat="food", bl="col322", conf="sure", emoji="🌵"),
    dict(th="ชุดยีราฟ", en="Giraffe Guy", series="The LEGO Movie 2", set_no="71023", date="ก.พ. 2019", sort=20190201, cat="animal", bl="tlm151", conf="sure", emoji="🦒"),
    dict(th="ชุดสีเทียน", en="Crayon Girl", series="The LEGO Movie 2", set_no="71023", date="ก.พ. 2019", sort=20190202, cat="craft", bl="tlm152", conf="sure", emoji="🖍️"),
    dict(th="ชุดแตงโม", en="Watermelon Dude", series="The LEGO Movie 2", set_no="71023", date="ก.พ. 2019", sort=20190203, cat="food", bl="tlm155", conf="sure", emoji="🍉"),
    dict(th="ชุดพิซซ่า", en="Pizza Costume Guy", series="Series 19", set_no="71025", date="ก.ย. 2019", sort=20190901, cat="food", bl="col351", conf="sure", emoji="🍕"),
    ...
    dict(th="ชุดไก่งวง", en="Turkey Costume", series="Series 23", set_no="71034", date="ก.ย. 2022", sort=20220901, cat="animal", bl="col406", conf="sure", emoji="🦃"),
    dict(th="ชุดมังกรเขียว", en="Green Dragon Costume", series="Series 23", set_no="71034", date="ก.ย. 2022", sort=20220902, cat="fantasy", bl="col409", conf="sure", emoji="🐲"),
    dict(th="ชุดป๊อปคอร์น", en="Popcorn Costume", series="Series 23", set_no="71034", date="ก.ย. 2022", sort=20220903, cat="food", bl="col404", conf="sure", emoji="🍿"),
